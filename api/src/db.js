...
const { Prod, Category, User, Comment, Purchase, UserAdmin, Delivery } = sequelize.models;
...
// User.belongsToMany(Delivery, { through: 'userDelivery' })
// Delivery.belongsToMany(User, { through: 'userDelivery' })
