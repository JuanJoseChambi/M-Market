...
export default function Home() {
  ...
  const { products } = useSelector((state) => state.products)
   ...
   const cardsShowed = (function () {
     if (products.length === 0) return products //Si no hay productos para mostrar
  ...
  return (
    <div>
      ...
      <Paginado currentPage={currentPage} cardsInPage={cardsInPage} totalCards={products?.length} setPagina={setPagina} />
